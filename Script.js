...
`
<li>
<div class="employee-card" id="employeel"> <img class="user-img" src="img/user.png" alt=""> 
    <span>
        <div class="employement-details" id="employeel-details">
...
function addInterview() {
    ...
    <li>
        <div class="list-item">
            ...
            <button class="accept-btn" type="button" name="button">Accept</button> <button class="reject-btn" type="button" name="button">Reject</button>
        </div>
    </li>
    `;
